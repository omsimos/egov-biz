...
import type {
  ...
  BnrsPaymentProviderStatus,
} from "./types.js";

export function normalizeEgovPayPaymentStatus(status: string): BnrsPaymentProviderStatus {
...
export function createEgovPayBnrsPaymentProvider(client: EgovPayClient): BnrsPaymentProvider {
  return {
    ...
    async getTransaction(transactionUuid): Promise<BnrsPaymentProviderSnapshot> {
      ...
      return {
        ...
        status: normalizeEgovPayPaymentStatus(data.payment_status),
